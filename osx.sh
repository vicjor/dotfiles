...
defaults write com.apple.menuextra.battery ShowPercent -string "YES" defaults write com.apple.menuextra.battery ShowTime -string "YES"
...
# echo "Disable the slow motion animations in finder, while holding shift"
...
# Empty Trash securely by default (NOT recommended on SSDs)
...
echo "Saving Screenshots to ~/Pictures/Screenshots/ from now on"
